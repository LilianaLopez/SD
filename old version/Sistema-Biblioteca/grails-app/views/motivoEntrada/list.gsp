...
<g:set var="entityName"
	value="${message(code: 'motivoEntrada.label', default: 'MotivoEntrada')}" />
...
<div class="row">
	<div class="col-md-12">
		<div class="content-panel" >
			<div class="col-md-12">
			<div class="col-sm-4">
			<h4><i class="fa fa-angle-right"></i> Lista de Motivos de Entrada</h4>
	       <hr>
	       </div>
	       	<div class="col-sm-8">
                        <a class="btn btn-theme03" href="/Sistema-Biblioteca/motivoEntrada/create"
			...
			<g:if test="${flash.message}">
				...
				<table   id="list-report" class="table table-striped table-advance table-hover" cellspacing="0" width="100%">
					...
					<tbody id="updateMe">
						<g:render template="/motivoEntrada/showResult"  id="updateMe"></g:render>
					</tbody>
				</table>
