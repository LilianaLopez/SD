...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${request.contextPath}/theme/assets/css/zabuto_calendar.css">
    <link rel="stylesheet" type="text/css" href="${request.contextPath}/theme/assets/js/gritter/css/jquery.gritter.css" />
    <link rel="stylesheet" type="text/css" href="${request.contextPath}/theme/assets/lineicons/style.css">    
  ...
  <script src="${request.contextPath}/theme/assets/js/chart-master/Chart.js"></script>
    ...
    <script class="include" type="text/javascript" src="${request.contextPath}/theme/assets/js/jquery.dcjqaccordion.2.7.js"></script>
    <script src="${request.contextPath}/theme/assets/js/jquery.scrollTo.min.js"></script>
    <script src="${request.contextPath}/theme/assets/js/jquery.nicescroll.js" type="text/javascript"></script>
    <script src="${request.contextPath}/theme/assets/js/jquery.sparkline.js"></script>


    <!--common script for all pages-->
    <script src="${request.contextPath}/theme/assets/js/common-scripts.js"></script>
    
    <script type="text/javascript" src="${request.contextPath}/theme/assets/js/gritter/js/jquery.gritter.js"></script>
    <script type="text/javascript" src="${request.contextPath}/theme/assets/js/gritter-conf.js"> </script>
