...
<div class="row">
	...
	<div class="col-md-6">
		<div class="form-group">
			<div class="fieldcontain ${hasErrors(bean: entradaInstance, field: 'motivoEntrada', 'error')} required">
				...
				<div class="col-sm-8">
					<g:select class="form-control" id="motivoEntrada" name="motivoEntradaId" from="${motivoEntradas}" optionKey="id" optionValue="descripcion" required="true" value="${entradaInstance?.motivoEntrada?.id}"/>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<div class="col-sm-10">	
				<g:textField class="form-control" placeholder="Ingrese una descripcion" maxlength="50" type = "text" required="true" name="descripcion" value="${entradaInstance?.descripcion}"/>
			</div>
		</div>
	</div>
