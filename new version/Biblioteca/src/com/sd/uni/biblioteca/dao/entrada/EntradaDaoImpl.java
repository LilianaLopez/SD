...
@Repository
public class EntradaDaoImpl extends BaseDaoImpl<EntradaDomain> implements IEntradaDao {
	@Autowired
	private SessionFactory sessionFactory;

	@Override
	public EntradaDomain save(EntradaDomain domain) {
		sessionFactory.getCurrentSession().saveOrUpdate(domain);
		return domain;
	}

	@Override
	public EntradaDomain getById(Integer domainId) {
		return (EntradaDomain) sessionFactory.getCurrentSession().get(EntradaDomain.class, domainId);
	}

	@Override
	public List<EntradaDomain> findAll() {
		final Criteria criteria = sessionFactory.getCurrentSession().createCriteria(EntradaDomain.class);
	...
	public List<EntradaDomain> find2(String textToFind) {
	...
	public List<EntradaDomain> find(String textToFind) {
		...
		Query q = sessionFactory.getCurrentSession().createQuery("from EntradaDomain where _descripcion like :parameter or _ like :parameter or _id=:id");
